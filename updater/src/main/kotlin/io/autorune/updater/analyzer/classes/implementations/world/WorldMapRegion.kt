...
class WorldMapRegion : ClassAnalyzer() {
    ...
    override fun findClassNode(): ClassNode? {
        for (classNode in classPool) {
            ...
            val match = classNode.fields.any { it.desc == String.format("L%s;", getClassAnalyserName(WorldMapData::class)) && !isMemberStatic(it.access) }
