...
class WorldMapArchiveLoader : ClassAnalyzer() {
    ...
    override fun findClassNode(): ClassNode? {
        for (classNode in classPool) {
            ...
            val match = classNode.fields.count { it.desc == String.format("L%s;", getClassAnalyserName(AbstractArchive::class)) && !isMemberStatic(it.access) } == 1
