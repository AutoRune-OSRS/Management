...
class ArchiveDiskAction : ClassAnalyzer() {
    ...
    override fun findClassNode(): ClassNode? {
        for (classNode in classPool) {
            ...
            val match = classNode.fields.count { !Modifier.isStatic(it.access) } == 4
                    && classNode.fields.count { it.desc == "[B" && !Modifier.isStatic(it.access) } == 1
